...
import com.grandstream.cast.airtunes.raop.AudioSession;
...
public class AudioOutputQueue {
	...
	public AudioOutputQueue(AudioSession audioSession) {
		...
		*/
		...
		sampleRateInHz = AirTunes.SAMPLE_RATE;
		channelConfig = AudioFormat.CHANNEL_OUT_STEREO;
		audioFormat = AudioFormat.ENCODING_PCM_16BIT;
		
		sampleRate = AirTunes.SAMPLE_RATE;
		
		/* Audio format-dependent stuff */
		packetSizeFrames = audioSession.getFramePerPacket();
		bytesPerFrame = audioSession.trackCount * audioSession.getSampleSize() / 8;
